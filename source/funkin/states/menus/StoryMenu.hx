...
class StoryMenu extends funkin.backend.MusicBeat.MusicBeatState
{
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			PlayState.SONG = funkin.backend.Song.loadJson(PlayState.storyPlaylist[0].toLowerCase() + diffic, PlayState.storyPlaylist[0].toLowerCase());
	...
	{
		curWeek = flixel.math.FlxMath.wrap(curWeek + change, 0, weekData.length - 1);
