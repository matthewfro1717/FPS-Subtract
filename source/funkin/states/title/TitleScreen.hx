...
class TitleScreen extends funkin.backend.MusicBeat.MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning)
		{
			...
			new flixel.util.FlxTimer().start(2, function(tmr) switchState(new funkin.states.menus.MainMenu()));
		}
