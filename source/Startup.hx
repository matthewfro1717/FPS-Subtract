...
class Startup extends flixel.FlxState
{
	...
	public static final songs:Array<String> = [
		...
		"Eggnog", "Winter-Horrorland", "Senpai", "Roses", "Thorns", "Ugh", "Guns", "Stress", "Lil-Buddies", "klaskiiLoop", "freakyMenu"
	...
	public static final characters:Array<String> = [
		...
		"week7/gfTankmen",
		"week1/DADDY_DEAREST",
		"week2/spooky_kids_assets",
		"week2/Monster_Assets",
	...
	public static final graphics:Array<String> = [
		...
		"gfDanceTitle2",
		"titleEnter",
		"fpsPlus/title/backgroundBf",
		"fpsPlus/title/barBottom",
		"fpsPlus/title/barTop",
		"fpsPlus/title/gf",
		"fpsPlus/title/glow",
		"week1/stageback",
		"week1/stagefront",
		...
		"week7/stage/tank4",
		"week7/stage/tank5",
		"week7/stage/tankmanKilled1",
		"week7/stage/smokeLeft",
		"week7/stage/smokeRight",
		"week7/stage/tankBuildings",
		"week7/stage/tankClouds",
		"week7/stage/tankGround",
		"week7/stage/tankMountains",
		"week7/stage/tankRolling",
		"week7/stage/tankRuins",
		"week7/stage/tankSky",
		"week7/stage/tankWatchtower"
	];
	...
	override function create()
	{
		...
		new FlxTimer().start(1.1, function(tmr:FlxTimer)
		{
			...
			new FlxTimer().start(1.0, function(tmr:FlxTimer)
			{
				...
				splash.animation.finishCallback = function(anim:String):Void FlxG.switchState(new funkin.states.title.TitleVideo());
			});
		});
