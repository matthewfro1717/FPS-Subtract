...
class ConfigMenuOld extends MusicBeatState {
	...
	override function create() {
		...
		tabDisplay.setFormat(Paths.font("vcr"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function getSetting(r:Int):String {
		switch (r) {
			...
			case 7:
				return ": " + genericOnOff[glowValue ? 0 : 1];
			case 8:
